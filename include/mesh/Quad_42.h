...
// --------------------------------------------------------------------------------------------------------
template<> struct NbChildrenElement<Quad_42,0> { static const unsigned res = 1; };
...
template<unsigned n> struct TypeChildrenElement<Quad_42,0,n> { typedef Quad_42 T; };
...
void append_skin_elements(Element<Quad_42,TN,TNG,TD,NET> &e,TC &ch,HET &het,Number<0> nvi_to_subs) {
    het.add_element(e,ch,Quad_42(),e.node(0),e.node(1),e.node(2),e.node(3),e.node(4),e.node(5),e.node(6),e.node(7));
}
template<class TN,class TNG,class TD,unsigned NET,class TC,class HET>
