...
// --------------------------------------------------------------------------------------------------------
template<> struct NbChildrenElement<Bar_7,0> { static const unsigned res = 1; };
template<> struct NbChildrenElement<Bar_7,1> { static const unsigned res = 2; };

template<unsigned n> struct TypeChildrenElement<Bar_7,0,n> { typedef Bar_7 T; };
template<unsigned n> struct TypeChildrenElement<Bar_7,1,n> { typedef NodalElement T; };

template<class TN,class TNG,class TD,unsigned NET,class TC,class HET>
void append_skin_elements(Element<Bar_7,TN,TNG,TD,NET> &e,TC &ch,HET &het,Number<0> nvi_to_subs) {
    het.add_element(e,ch,Bar_7(),e.node(0),e.node(1),node(2),e.node(3),node(4),e.node(5),node(6));
}
template<class TN,class TNG,class TD,unsigned NET,class TC,class HET>
