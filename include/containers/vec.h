...
\generic_comment apply
    ...
    = Les variantes
        ...
        = Un seul vecteur
            ...
            * \a apply_range_by_n 
            * \a apply_nz_wi est plutôt utilisée pour les vecteurs creux ( \a Vec<Sparse<TT>,static_size_> ) car le traitement n'est fait que sur les éléments instanciés (donc a priori non nul).
