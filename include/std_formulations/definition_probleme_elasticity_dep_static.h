...
public:
    ...
    T reg0=0.25*elem.pos(1)[2]; T reg1=0.25*elem.pos(0)[2]; T reg2=0.25*elem.pos(1)[1]; T reg3=0.25*elem.pos(0)[1]; T reg4=0.25*elem.pos(2)[2];
    T reg5=reg0+reg1; T reg6=reg2+reg3; reg1=reg0-reg1; reg3=reg2-reg3; reg0=0.25*elem.pos(2)[1];
    reg2=reg4-reg5; T reg7=0.25*elem.pos(0)[0]; T reg8=0.25*elem.pos(1)[0]; reg1=reg4+reg1; T reg9=reg0-reg6;
    T reg10=0.25*elem.pos(3)[2]; T reg11=0.25*elem.pos(3)[1]; reg5=reg4+reg5; reg6=reg0+reg6; reg0=reg3+reg0;
    reg0=reg0-reg11; reg2=reg2+reg10; reg3=0.25*elem.pos(4)[2]; reg4=0.25*elem.pos(4)[1]; reg9=reg11+reg9;
    T reg12=reg7+reg8; reg1=reg1-reg10; T reg13=0.25*elem.pos(2)[0]; reg6=reg11+reg6; reg5=reg10+reg5;
    reg7=reg8-reg7; reg1=reg1-reg3; reg8=0.25*elem.pos(5)[1]; reg0=reg0-reg4; reg10=reg13-reg12;
    reg6=reg4-reg6; reg5=reg3-reg5; reg7=reg13+reg7; reg3=reg2-reg3; reg2=0.25*elem.pos(5)[2];
    reg11=0.25*elem.pos(3)[0]; reg4=reg9-reg4; reg10=reg11+reg10; reg1=reg2+reg1; reg9=0.25*elem.pos(4)[0];
    reg6=reg8+reg6; reg4=reg4-reg8; reg5=reg2+reg5; reg13=reg12+reg13; reg12=0.25*elem.pos(6)[2];
    reg2=reg3-reg2; reg7=reg7-reg11; reg3=0.25*elem.pos(6)[1]; reg8=reg0+reg8; reg0=0.25*vectors[0][indices[1]+0];
    T reg14=0.25*vectors[0][indices[1]+1]; T reg15=0.25*vectors[0][indices[0]+1]; reg1=reg12+reg1; T reg16=0.25*vectors[0][indices[0]+2]; T reg17=0.25*vectors[0][indices[1]+2];
    reg11=reg13+reg11; reg13=0.25*elem.pos(5)[0]; reg10=reg10-reg9; reg7=reg7-reg9; T reg18=0.25*vectors[0][indices[0]+0];
    T reg19=0.25*elem.pos(7)[1]; reg5=reg12+reg5; reg6=reg3+reg6; T reg20=1+(*f.m).poisson_ratio; T reg21=0.25*elem.pos(7)[2];
    reg4=reg3+reg4; reg3=reg8+reg3; reg12=reg2+reg12; reg2=reg0-reg18; reg8=reg17-reg16;
    reg12=reg12+reg21; reg7=reg13+reg7; T reg22=reg14-reg15; T reg23=0.25*vectors[0][indices[2]+0]; reg0=reg18+reg0;
    reg5=reg21+reg5; reg17=reg16+reg17; reg16=0.25*vectors[0][indices[2]+2]; reg20=reg20/(*f.m).elastic_modulus; reg10=reg10-reg13;
    reg6=reg19+reg6; reg4=reg19+reg4; reg18=0.25*elem.pos(6)[0]; reg11=reg9-reg11; reg21=reg1-reg21;
    reg1=0.25*vectors[0][indices[2]+1]; reg14=reg15+reg14; reg19=reg3-reg19; reg3=0.25*vectors[0][indices[3]+0]; reg10=reg18+reg10;
    reg9=reg19*reg5; reg15=reg21*reg6; T reg24=0.25*vectors[0][indices[3]+1]; T reg25=reg1-reg14; reg2=reg23+reg2;
    T reg26=pow(reg20,2); T reg27=reg23-reg0; T reg28=reg16-reg17; reg22=reg1+reg22; T reg29=reg12*reg6;
    reg7=reg18+reg7; T reg30=0.25*elem.pos(7)[0]; T reg31=reg4*reg5; reg13=reg11+reg13; reg11=0.25*vectors[0][indices[3]+2];
    reg8=reg16+reg8; reg7=reg7-reg30; T reg32=0.25*vectors[0][indices[4]+2]; T reg33=0.25*vectors[0][indices[4]+1]; reg25=reg25+reg24;
    T reg34=reg19*reg12; T reg35=reg4*reg21; reg28=reg11+reg28; reg2=reg2-reg3; reg20=reg20*reg26;
    reg18=reg13+reg18; reg1=reg14+reg1; reg27=reg3+reg27; reg8=reg8-reg11; reg22=reg22-reg24;
    reg29=reg31-reg29; reg15=reg9-reg15; reg16=reg17+reg16; reg9=(*f.m).poisson_ratio/(*f.m).elastic_modulus; reg13=0.25*vectors[0][indices[4]+0];
    reg10=reg30+reg10; reg14=1.0/(*f.m).elastic_modulus; reg23=reg0+reg23; reg25=reg25-reg33; reg0=0.25*vectors[0][indices[5]+1];
    reg22=reg22-reg33; reg35=reg34-reg35; reg28=reg28-reg32; reg17=reg7*reg29; reg27=reg27-reg13;
    reg31=reg10*reg15; reg34=0.25*vectors[0][indices[5]+0]; T reg36=reg14*reg20; reg11=reg16+reg11; reg1=reg24+reg1;
    reg2=reg2-reg13; reg30=reg18+reg30; reg16=0.25*vectors[0][indices[5]+2]; reg20=reg9*reg20; reg8=reg8-reg32;
    reg3=reg23+reg3; reg18=reg12*reg30; reg23=reg5*reg10; reg24=reg19*reg30; T reg37=reg4*reg30;
    reg22=reg0+reg22; T reg38=reg7*reg6; reg28=reg28-reg16; reg1=reg33-reg1; reg8=reg16+reg8;
    reg11=reg32-reg11; reg32=0.25*vectors[0][indices[6]+2]; reg6=reg6*reg10; reg33=reg35*reg30; reg31=reg17-reg31;
    reg3=reg13-reg3; reg13=0.25*vectors[0][indices[6]+0]; reg17=reg9*reg36; T reg39=reg9*reg20; reg2=reg34+reg2;
    reg36=reg14*reg36; reg27=reg27-reg34; reg5=reg7*reg5; reg25=reg25-reg0; reg30=reg21*reg30;
    T reg40=0.25*vectors[0][indices[6]+1]; T reg41=reg9*reg26; reg18=reg23-reg18; reg34=reg3+reg34; reg36=reg36-reg39;
    reg31=reg33+reg31; reg24=reg38-reg24; reg8=reg32+reg8; reg4=reg4*reg7; reg26=reg14*reg26;
    reg16=reg11+reg16; reg20=reg14*reg20; reg17=reg39+reg17; reg3=0.25*vectors[0][indices[7]+2]; reg11=0.25*vectors[0][indices[7]+0];
    reg37=reg6-reg37; reg30=reg5-reg30; reg19=reg19*reg10; reg1=reg0+reg1; reg0=0.25*vectors[0][indices[7]+1];
    reg2=reg13+reg2; reg25=reg25+reg40; reg27=reg13+reg27; reg10=reg21*reg10; reg7=reg12*reg7;
    reg28=reg32+reg28; reg22=reg40+reg22; reg8=reg8-reg3; reg37=reg37/reg31; reg20=reg39+reg20;
    reg5=reg9*reg26; reg6=reg9*reg17; reg28=reg3+reg28; reg12=reg14*reg36; reg26=reg14*reg26;
    reg2=reg2-reg11; reg24=reg24/reg31; reg19=reg4-reg19; reg4=reg9*reg41; reg32=reg16+reg32;
    reg25=reg25+reg0; reg27=reg11+reg27; reg30=reg30/reg31; reg15=reg15/reg31; reg13=reg34+reg13;
    reg1=reg40+reg1; reg18=reg18/reg31; reg10=reg7-reg10; reg29=reg29/reg31; reg22=reg22-reg0;
    reg7=reg27*reg24; reg16=reg22*reg37; reg21=reg18*reg8; reg23=reg30*reg28; reg33=reg2*reg18;
    reg34=reg2*reg37; reg38=reg15*reg28; reg39=reg29*reg8; reg40=reg15*reg25; T reg42=reg29*reg22;
    reg19=reg19/reg31; T reg43=reg25*reg24; reg15=reg15*reg27; reg2=reg29*reg2; reg11=reg13+reg11;
    reg35=reg35/reg31; reg6=reg12-reg6; reg12=reg9*reg20; reg41=reg14*reg41; reg26=reg26-reg4;
    reg5=reg4+reg5; reg25=reg25*reg30; reg22=reg18*reg22; reg30=reg27*reg30; reg3=reg32+reg3;
    reg31=reg10/reg31; reg1=reg0+reg1; reg7=reg34-reg7; reg33=reg30-reg33; reg0=reg31*reg1;
    reg12=reg6-reg12; reg8=reg37*reg8; reg21=reg23-reg21; reg6=reg31*reg3; reg10=reg1*reg19;
    reg43=reg16-reg43; reg13=reg35*reg11; reg22=reg25-reg22; reg24=reg28*reg24; reg26=reg14*reg26;
    reg15=reg2-reg15; reg31=reg11*reg31; reg11=reg11*reg19; reg38=reg39-reg38; reg5=reg9*reg5;
    reg2=reg4+reg41; reg14=reg35*reg3; reg40=reg42-reg40; reg1=reg35*reg1; reg7=reg11+reg7;
    reg15=reg13+reg15; elem.epsilon[0][0]=reg15; reg24=reg8-reg24; reg31=reg33-reg31; reg20=reg20/reg12;
    reg1=reg40+reg1; reg43=reg10+reg43; reg2=reg9*reg2; reg19=reg3*reg19; reg5=reg26-reg5;
    reg6=reg21-reg6; reg38=reg14+reg38; reg17=reg17/reg12; reg36=reg36/reg12; reg0=reg22-reg0;
    elem.epsilon[0][1]=reg0; reg2=reg5-reg2; reg3=reg0*reg17; reg43=reg6+reg43; reg5=reg36*reg15;
    reg1=reg31+reg1; reg6=reg0*reg20; reg7=reg38+reg7; reg8=reg36*reg0; reg9=reg15*reg17;
    reg24=reg19+reg24; elem.epsilon[0][2]=reg24; reg43=0.5*reg43; elem.epsilon[0][5]=reg43; reg10=reg36*reg24;
    reg7=0.5*reg7; elem.epsilon[0][4]=reg7; reg8=reg9+reg8; reg12=reg2/reg12; reg2=reg24*reg20;
    reg3=reg5+reg3; reg6=reg9+reg6; reg0=reg15+reg0; reg1=0.5*reg1; elem.epsilon[0][3]=reg1;
    elem.sigma[0][1]=reg2+reg8; elem.tr_epsilon=reg24+reg0; elem.sigma[0][2]=reg6+reg10; elem.sigma[0][3]=reg1*reg12; elem.sigma[0][4]=reg7*reg12;
    elem.sigma[0][5]=reg43*reg12; elem.sigma[0][0]=reg3+reg2;
      #undef PNODE
    }
